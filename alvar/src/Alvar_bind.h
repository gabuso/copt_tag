#ifndef __NODE_ALVAR_H__
#define __NODE_ALVAR_H__
...
class Alvar: public node::ObjectWrap{
  public:
    ...
    Camera cam;
     ...
     JSFUNC(treatImageBuffer)
     JSFUNC(GetNumMarkerDetected)
     JSFUNC(GetMarkersCoord)
     JSFUNC(GetHomography)
     JSFUNC(GetDepthPix)
     JSFUNC(ReadImage)
     JSFUNC(ReadHomography)
